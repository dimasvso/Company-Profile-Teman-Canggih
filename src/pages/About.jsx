    ...
    <>
      <section className="bg-[#0F172A] min-h-screen">
        ...
        <section className="min-h-screen text-white flex flex-col justify-center gap-8 md:gap-12 items-center text-center px-6">
          ...
          <p className="max-w-3xl text-center text-sm md:text-base leading-relaxed text-slate-300">
        ...
        <section className="flex items-center justify-center -mt-10 py-15 px-6">
          <div className="relative group max-w-4xl">
            <div className="absolute rounded-[2rem] blur opacity-20 group-hover:opacity-40 transition duration-1000"></div>

            <div className="relative bg-[#1E293B] p-3 md:p-4 rounded-[2rem] shadow-2xl overflow-hidden border border-slate-700">
              <img
                src={TemanCanggih}
                className="w-full h-auto rounded-[1.5rem] object-cover grayscale-[20%] hover:grayscale-0 transition duration-700"
