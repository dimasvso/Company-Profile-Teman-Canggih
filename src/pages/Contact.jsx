...
const Contact = () => {
  return (
    <div className="min-h-screen bg-black flex items-center justify-center md:py-26 font-sans">
      <div className="bg-white rounded-lg shadow-xl flex flex-col md:flex-row w-full max-w-6xl overflow-hidden p-2">
        
        {/* Bagian Kiri: Informasi Kontak */}
        {/* Penyesuaian: Mengurangi padding di mobile (p-6) dan tetap p-10 di desktop */}
        <div className="bg-black text-white p-6 md:p-10 md:w-[40%] rounded-lg relative overflow-hidden flex flex-col justify-between min-h-100 md:min-h-full">
          <div className="relative z-10">
            <h2 className="text-2xl md:text-3xl font-semibold mb-2">Contact Information</h2>
            <p className="text-gray-400 text-sm mb-8 md:mb-12">Say something to start a live chat!</p>
          ...
          {/* Social Media */}
          <div className="mt-12 md:mt-16 flex gap-4 relative z-10">
          ...
          {/* Penyesuaian: Mengatur ukuran lingkaran agar tidak menutupi teks di mobile */}
          <div className="absolute -bottom-12 -right-12 w-32 h-32 md:w-48 md:h-48 bg-zinc-800 rounded-full opacity-50"></div>
          <div className="absolute bottom-6 right-6 md:bottom-10 md:right-10 w-20 h-20 md:w-28 md:h-28 bg-zinc-700 rounded-full opacity-30"></div>
        </div>
    
        {/* Bagian Kanan: Form */}
        <div className="p-6 md:p-10 md:w-[60%] bg-white">
          <form className="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-8 md:gap-y-10">
            ...
            {/* Submit Button */}
            {/* Penyesuaian: Tombol full width di mobile, auto di desktop */}
            <div className="md:col-span-2 flex justify-end mt-4">
              <button 
                type="submit"
                className="w-full md:w-auto bg-black cursor-pointer text-white px-12 py-4 rounded shadow-lg hover:bg-zinc-800 transition-all text-sm font-medium"
              >
                Send Message
              </button>
            </div>
