...
import { FaTwitter, FaInstagram, FaDribbble, FaMediumM, FaBars, FaTimes, FaLinkedinIn, FaFacebookF } from "react-icons/fa";
...
const Navbar = ({ variant = "none" }) => {
  ...
  return (
    <nav className={`fixed top-0 left-0 w-full z-100 transition-all duration-500 px-6 lg:px-20 py-4 flex items-center justify-between ${isScrolled || isOpen ? "bg-black/70 backdrop-blur-md shadow-lg" : "bg-transparent"
      }`}>
